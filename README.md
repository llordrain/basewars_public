## Im not consistent at all and there's a lot of shit in the gamemode (or stuff that's really old, like 1 or 2 years old) so as it says in the LICENSE it is `AS IS` AKA you're on your own :]
