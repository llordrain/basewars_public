...
function PANEL:Init()
    ...
    self.R:SetColor(GetBaseWarsTheme("bwm_background"))
    self.R:SetTextColor(GetBaseWarsTheme("colorpicker_r"))
    self.R:SetFont("BaseWars.18")
    self.R:SetPlaceHolder("R")
    self.R:SetPlaceHolderColor(GetBaseWarsTheme("bwm_darkText"))
    ...
    self.G:SetColor(GetBaseWarsTheme("bwm_background"))
    self.G:SetTextColor(GetBaseWarsTheme("colorpicker_g"))
    self.G:SetFont("BaseWars.18")
    self.G:SetPlaceHolder("G")
    self.G:SetPlaceHolderColor(GetBaseWarsTheme("bwm_darkText"))
    ...
    self.B:SetColor(GetBaseWarsTheme("bwm_background"))
    self.B:SetTextColor(GetBaseWarsTheme("colorpicker_b"))
    self.B:SetFont("BaseWars.18")
    self.B:SetPlaceHolder("B")
    self.B:SetPlaceHolderColor(GetBaseWarsTheme("bwm_darkText"))
