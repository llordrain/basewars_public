...
hook.Add("BaseWars:ClearDatabase", "BaseWars:Prestige", function()
    MySQLite.query("DROP TABLE basewars_prestige", function()
        BaseWars:SQLLogs("Deleted table \"basewars_prestige\"")
    end, BaseWarsSQLError)
end)